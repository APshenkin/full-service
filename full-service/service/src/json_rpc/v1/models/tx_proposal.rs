...
use crate::{
    ...
    service::models::wrapped_tx_proposal::WrappedTxProposal as TxProposalServiceModel
};
...
impl TryFrom<&TxProposalServiceModel> for TxProposal {
    ...
    fn try_from(src: &TxProposalServiceModel) -> Result<Self, String> {
        let mcd_tx_proposal = mc_mobilecoind::payments::TxProposal::try_from(src.0.clone())?;
