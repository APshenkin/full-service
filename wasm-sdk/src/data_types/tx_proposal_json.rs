...
use crate::data_types::tx_proposal::TxProposal;
...
impl TryFrom<&TxProposal> for TxProposalJSON {
    type Error = String;

    fn try_from(src: &TxProposal) -> Result<Self, String> {
        let input_txos = src
            .input_txos
            .iter()
        ...
        let payload_txos = src
            ...
            .collect::<Result<Vec<OutputTxo>, String>>()
